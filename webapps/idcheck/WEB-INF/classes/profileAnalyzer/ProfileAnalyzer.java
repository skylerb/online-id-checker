...
public class ProfileAnalyzer {
	...
	public static float compareTwoProf(String a, String b){
		  JaroDistance score = new JaroDistance();
		  float res = (float)score.d2(a,b);
		   return res;
	}
	// for comparing profiles from Three Social Networks
	public static float compareThreeProf(String a, String b, String c){
	...
	public static float compareFourProf(String a, String b, String c, String d){
